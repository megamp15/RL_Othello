...
<<<<<<< HEAD
    ...
    def train_QLearning(self, episodes=EPISODES, max_steps=MAX_STEPS) -> None:
        ...
        # Q-Learning Agents
        Agent = DQN(state_shape=obs.shape, num_actions=self.env.action_space.n,net_type=PixelNeuralNet, epsilon=EPSILON, epsilon_decay_rate=EPSILON_DECAY_RATE, epsilon_min=EPSILON_MIN, alpha=ALPHA, gamma=GAMMA, skip_training=SKIP_TRAINING, save_interval=SAVE_INTERVAL, sync_interval=SYNC_INTERVAL, max_memory=10_000)
